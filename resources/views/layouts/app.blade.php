...
<body>
    <div id="app">
        <nav class=" navbar navbar-expand-md">
            ...
            <div class="nav d-flex flex-column justify-content-end ">
            <ul class="dropdown dropdown-menu dropdown-menu-right " >
                <!-- Authentication Links -->
                @guest
                    @if (Route::has('login'))
                        <li class="nav-item">
                            <a id="navbarDropdown" class="nav-link dropdown-item" href="{{ route('login') }}">{{ __('Вход') }}</a>
                        </li>
                    @endif

                    @if (Route::has('register'))
                        <li class="nav-item">
                            <a class="nav-link dropdown-item" href="{{ route('register') }}">{{ __('Регистрация') }}</a>
                        </li>
                    @endif
                @else
